	...
	public void nhap() {
		...
		for(int i = 0; i < soluong; i++) {
			while(true) {
				...
				check = in.nextInt();
				if(check == 1) {
					ds[i] = new ThuocChuaBenh();
					ds[i].nhap();
					break;
				}else if(check == 2) {
					ds[i] = new ThuocNgoaiDa();
					ds[i].nhap();
					break;
				}
			}
	...
	public void them() {
		while(true) {
	        ...
	        if(isDuplicate == false) {
	            ...
	            soluong += 1;
	            if(check == 1) {
	            	ds[soluong - 1] = new ThuocChuaBenh();
	            }else {
	            	ds[soluong - 1] = new ThuocNgoaiDa();
	            }
	            ds[soluong - 1] = sp;
  ...
  //Search with name: given name
    ...
    public void sua(String masp) {
    	...
    	while(true) {
        	...
        	SanPham tempSp;
        	if(check == 1) {
        		tempSp = new ThuocChuaBenh();
        		tempSp.nhap();
        	}else {
        		tempSp = new ThuocNgoaiDa();
        		tempSp.nhap();
        	}
        	...
        	if(isDuplicate == false) {
        		if(check == 1) {
        			ds[pos] =  new ThuocChuaBenh();
        			ds[pos] = tempSp;
        		}else {
        			ds[pos] =  new ThuocNgoaiDa();
        			ds[pos] = tempSp;
        		}
    	...
    	try {
    		while(true) {
    			...
    			if(checkSp.equals("t") == true) {
    				...
    				ds[i] = new ThuocChuaBenh(productId,tensp,loaisp,gia,solco,nlc,xx);
    				...
    				ds[i] = new ThuocNgoaiDa(productId,tensp,loaisp,gia,solco,hvi);
    			}
    			i++;
    		}
